...
const sk = ['\u013A', '\u013E', '\u0148', '\u0155', '\u0165', '\u00FA', '\u00F4', '\u00C4', '\u010E', '\u0139', '\u013D', '\u0147', '\u0154', '\u0164', '\u00DA', '\u00D4', '\u00CD', '\u00D3', '\u00DD', '\u00E1', '\u00E9', '\u00ED', '\u00F3', '\u00FD', '\u010C', '\u010D', '\u010F', '\u0160', '\u0161', '\u017D', '\u017E', '\u00E4', '\u00C9', '\u00C1']
const cz = ['\u0148', '\u0165', '\u00FA', '\u010E', '\u0147', '\u0164', '\u00DA', '\u00CD', '\u00D3', '\u00DD', '\u00E1', '\u00E9', '\u00ED', '\u00F3', '\u00FD', '\u010C', '\u010D', '\u010F', '\u0160', '\u0161', '\u017D', '\u017E', '\u00C9', '\u00C1', '\u011A', '\u011B', '\u0159', '\u0158', '\u016E', '\u016F']

/**
 * Remove duplicates
 */
const all = [...sk, ...cz].reduce((acc, curr) => {
    if (!acc.find(i => i === curr))
        return [...acc, curr]
    return acc
}, [])
